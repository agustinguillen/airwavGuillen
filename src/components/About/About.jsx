    ...
    <div className="container about-container text-center mt-3">
      ...
      <div className="row">
        ...
        <div className="col-lg-6 col-md description-container">
          ...
          <div className="mt-3">
            <p align="left">
              Somos una empresa de la Ciudad de La Plata con 10 años de
              experiencia dedicada a la venta de instrumentos musicales. Airwav
              nació en el año 2011 en la ciudad de La Plata, creada por musicos
              de basta experiancia en el rubro. Tenemos vendedores capacitados y
              atentos a las necesidades e intereses de nuestros clientes.
            </p>
            <p align="left">
              Contamos con un amplio local/showroom en calle 50 Nro 999 de la
              ciudad de La Plata donde podes probar y elegir en forma personal
              los productos de nuestro catálogo con marcas de primer nivel, así
              también como variedad de precios. No dudes en consultarnos lo que
              quieras, estamos a tu dispocicion siempre. Mandanos mail a
              ventas@airwav.com y sera respondido en un corto plazo.
            </p>
          </div>
        </div>
      </div>
